...
La base de datos se aloja en un contenedor local de MySQL.
...
#DATABASE_URL = "mysql+pymysql://root:Joaco06151970@localhost:6666/liquidation"
DATABASE_URL="mysql+pymysql://root:Joaco06151970@mysql_db:3306/liquidation
```
...
│
├── k8s/ # Configuraciones de Kubernetes (Deployments, Services, etc.)
...
│   ├── secret.yaml
│   └── prometheus.yaml # Este archivo también lo tienes en la raíz
│
